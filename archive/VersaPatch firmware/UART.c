...
static BYTE txBuf[UART_TXBUF_SIZE]__attribute__ ((space(dma)));
static BYTE txgetidx;   
static BYTE txputidx;   
static BYTE rxBuf[UART_RXBUF_SIZE] __attribute__ ((space(dma)));
static BYTE rxputidx;   
static BYTE rxgetidx;   

static BYTE txBuf2[UART_TXBUF_SIZE] __attribute__ ((space(dma)));
static BYTE txgetidx2;   
static BYTE txputidx2;   
static BYTE rxBuf2[UART_RXBUF_SIZE] __attribute__ ((space(dma)));
