...
//defined in "C Compiler Addendum.pdf" document
        ...
        #pragma config WDTPS = 128      // Watchdog prescaler = 128. This gives: min=435ms, typ=512ms, max=589ms
        //#pragma config WDTPS = 256      // Watchdog prescaler = 256. This gives: min=0.87s, typ=1.024s, max=1.178s
        //#pragma config WDTPS = 512      // Watchdog prescaler = 512. This gives: min=1.74s, typ=2.048s, max=2.356s
