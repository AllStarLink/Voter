...
#define CMD_UD_I2C_LCD      0x0400      /* Update the I2C LCD settings */
#define CMD_UD_BUSBUF       0x0800      /* Update the Serial Buses Buffer settings */
#define CMD_UD_BUSNET       0x1000      /* Update the Bus Network settings */
#define CMD_UD_XBOARD       0x2000      /* Update the Expansion Board settings */
