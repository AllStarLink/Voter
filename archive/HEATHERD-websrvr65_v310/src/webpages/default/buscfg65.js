function bufcfg(tx0, rx0, tx1, rx1, tx2, rx2, linkUDP1, linkUDP2) {
	...
	<table class=bBox cellpadding=3 cellspacing=1> \
		...
		<tr><td class=bLbl>UDP Bus 1</td> \
			...
			<option value=1>Serial Port2</option> \
		...
		\
		<tr><td class=bLbl>Serial Port 2 Transmit Buffer</td> \
		<td class=bCtr width=\"100%\"><input type=text size=10 maxlength=3 value=" + tx1 + " name=u02></td></tr> \
		<tr><td class=bLbl>Serial Port 2 Receive Buffer</td> \
		<td class=bCtr width=\"100%\"><input type=text size=10 maxlength=3 value=" + rx1 + " name=u03></td></tr> \
		\
