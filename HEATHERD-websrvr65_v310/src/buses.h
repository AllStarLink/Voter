...
typedef struct _BUS_BUFFER
{
    ...
    BUFTYPE putTx;      //put pointer for TxBuffer
    BUFTYPE getTx;      //get pointer for TxBuffer
    ...
    BUFTYPE putRx;      //put pointer for RxBuffer
    BUFTYPE getRx;      //get pointer for RxBuffer
...
/**
 * Gets a byte from the TX Buffer. The buffer pointers are NOT updated! After calling
 * this function, the 
 *
 * @preCondition busIsTxBufEmpty() must have been called to confirm the TX Buffer has data!
 *
...
/**
 * Gets a byte from the RX Buffer. The buffer pointers are NOT updated! After calling
 * this function, the 
 *
 * @preCondition busIsRxBufEmpty() must have been called to confirm the RX Buffer has data!
 *
