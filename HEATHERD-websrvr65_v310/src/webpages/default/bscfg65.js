function bscfg(baud1, ser1Cfg, baud2, ser2Cfg) {
	...
	<table class=bBox cellpadding=3 cellspacing=1> \
		...
		<tr><td class=bHdr colspan=2>USART 2 Settings</td></tr> \
		...
		<tr><td class=bSec colspan=2>Parameters</td></tr> \
		<tr><td class=bLbl>Enable USART 2</td> \
			<td class=bCtr><input type=checkbox id=ser2_0 "+((ser2Cfg&0x01)?"checked":"")+"> &nbsp; \
			<i>If checked, USART2 is enabled.</i></td> \
		</tr> \
		<tr><td class=bLbl>Baud Rate</td> \
			<td class=bCtr width=\"100%\"><select name=k21 id=selectBaud2 size=1> \
			<option value=0>300</option> \
			<option value=1>1200</option> \
			<option value=2>2400</option> \
			<option value=3>4800</option> \
	...
	selOpt(document.getElementById("selectBaud2"), 'x', baud2);
}

function bscfgSubmit() {
	document.getElementsByName("k20")[0].value = getCbxByte("ser1_",0);
	document.getElementsByName("k22")[0].value = getCbxByte("ser2_",0);
}
