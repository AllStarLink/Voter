function pwmcfg(mode, enable, freq) {
	...
	<table class=bBox cellpadding=3 cellspacing=1> \
		...
		<tr><td class=bLbl>Channel 3 (Port G0)</td><td class=bCtr><input type=checkbox id=en2 " + ((enable&0x04)?"checked":"") + "></td></tr> \
		<tr><td class=bLbl>Channel 4 (Port G3)</td><td class=bCtr><input type=checkbox id=en3 " + ((enable&0x08)?"checked":"") + "></td></tr> \
